...
-- ==================================================
--DROP SCHEMA BOWLS RESTRICT;
--CREATE SCHEMA BOWLS; -- AUTHORIZATION userName;
--To create a schema that uses the same name as the authorization ID BOWLS
--CREATE SCHEMA AUTHORIZATION BOWLS;
...
CREATE TABLE BOTANICSYSTEM (
	...
	,BOTANICSYSTEM_ORDNUNG			VARCHAR(035)	NOT NULL DEFAULT ''
	,BOTANICSYSTEM_FAMILIE			VARCHAR(035)	NOT NULL DEFAULT ''
	,BOTANICSYSTEM_UNTERFAMILIE 	VARCHAR(035)	NOT NULL DEFAULT ''
